  ...
  Widget build(BuildContext context) {
      ...
      Row(mainAxisAlignment: MainAxisAlignment.end, children: [
        ...
        Row(children: const [
          NavBarItemWithIcon(
            ...
            url: 'https://github.com/a7medzzzz/a7medzzzz',
          ),
          SizedBox(width: 10),
          NavBarItemWithIcon(
              text: 'facebook',
              icon: ImageAssetConstants.facebook,
              url: 'https://www.facebook.com/profile.php?id=100000655103064'),
          SizedBox(width: 10),
          NavBarItemWithIcon(
              text: 'linkedIn',
              icon: ImageAssetConstants.linkedIn,
              url: 'https://www.linkedin.com/in/ahmed-al-hariri'),
          SizedBox(width: 50),
        ])
      ])
    ]);
    List<Widget>? navBarColumn = [
      ...
      NavBarItem(
          text: 'github',
          onTap: () async {
            await launch('https://github.com/a7medzzzz/a7medzzzz');
          }),
      NavBarItem(
          text: 'facebook',
          onTap: () async =>
              await launch('https://www.facebook.com/profile.php?id=100000655103064')),
      NavBarItem(
          text: 'linkedIn',
          onTap: () async => await launch('https://www.linkedin.com/in/ahmed-al-hariri')),
    ];
    return Stack(
      children: [
        ObxValue<RxDouble>(
