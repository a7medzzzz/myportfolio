      ...
      child: Column(
        ...
        children: [
          Container(
              ...
              child: Center(
                  child: Text('Information Systems Engineer',
          ...
          SizedBox(
            ...
            child: AnimatedTextKit(
              ...
              animatedTexts: [
                TyperAnimatedText(
                    "I'm develpoer Web,mobile,frontend and backend applications",
          ...
          InkWell(
            onTap: () async => !await launch(
                'https://mail.google.com/mail/u/0/?fs=1&to=you-187@hotmail.com&tf=cm'),
